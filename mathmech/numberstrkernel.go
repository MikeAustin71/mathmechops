...
//
//	nStrKernel,
//	err = new(mathmech.NumberStrKernel).
//		NewFromStringDigits(
//			intDigits,
//			"",
//			mathmech.NumSignVal.Positive(),
//			ePrefix.XCpy(
//			"nStrKernel"))
//
//	if err != nil {
...
//	}
//
//	numFmtSpec := mathmech.NumStrFmtCharReplacementSpec{
...
//	FmtCurrencyBasic
//
//	Creates and returns a number string configured using
//	a 'basic' set of Number String Format Specification
//	parameters.
//
//	The returned number string will include the
//	formatted numeric value contained in the current
//	instance of NumberStrKernel. Formatting
//	specifications are provided by the input parameters
//	described below.
//
// ----------------------------------------------------------------
//
...
//		text will be attached to the beginning of the
//		error message.
func (numStrKernel *NumberStrKernel) FmtCurrencyBasic(
	roundingSpec NumStrRoundingSpec,
	decSeparatorChars string,
	intSeparatorChars string,
	intGroupingType IntegerGroupingType,
	...
	numStrFmtSpec,
		err = new(NumStrFormatSpec).NewCurrencyBasic(
		decSeparatorChars,
		intSeparatorChars,
		intGroupingType,
...
//		NumberStrKernel.FmtNumStrParams()
//
// ----------------------------------------------------------------
//
// # Reference:
...
//	FmtCurrencyDefaultsUKMinusInside
//
//	Returns a formatted number string based on the
//	numeric value contained in the current instance
//	of NumberStrKernel and the Currency Number
...
//	instance of NumberStrKernel with UK Currency Number
...
//		text will be attached to the beginning of the
//		error message.
func (numStrKernel *NumberStrKernel) FmtCurrencyDefaultsUKMinusInside(
	roundingSpec NumStrRoundingSpec,
	numberFieldSpec NumStrNumberFieldSpec,
	errorPrefix interface{}) (
	string,
...
// FmtCurrencyDefaultsUKMinusOutside
//
//	Returns a formatted number string based on the
//	numeric value contained in the current instance
//	of NumberStrKernel and the Currency Number
...
//		text will be attached to the beginning of the
//		error message.
func (numStrKernel *NumberStrKernel) FmtCurrencyDefaultsUKMinusOutside(
	roundingSpec NumStrRoundingSpec,
	numberFieldSpec NumStrNumberFieldSpec,
	errorPrefix interface{}) (
	string,
...
//
//	Creates and returns a number string configured using
//	a 'simple' set of Currency Number String Format
//	Specification parameters.
//
//	The returned number string will include the
//	formatted numeric value contained in the current
//	instance of NumberStrKernel. Currency Formatting
//	Specifications are provided by the input parameters
//	described below.
//
//	If Currency Symbols are not required, consider
//	the Signed Number Formatting specifications
//	provided by method:
//
//		NumberStrKernel.FmtSignedNumStrSimple()
//
// ----------------------------------------------------------------
//
// # Input Parameters
...
//		text will be attached to the beginning of the
//		error message.
func (numStrKernel *NumberStrKernel) FmtCurrencySimple(
	roundingSpec NumStrRoundingSpec,
	decSeparatorChars string,
	intSeparatorChars string,
	currencySymbols string,
	...
	numStrFmtSpec,
		err = new(NumStrFormatSpec).NewCurrencySimple(
		decSeparatorChars,
		intSeparatorChars,
		currencySymbols,
...
//		fracDigits := ""
//
//		sMechNStrKernel := mathmech.NumberStrKernel{}
//		numberSign := mathmech.NumSignVal.None()
//
//		numStrKernel,
...
//
//		var roundType = mathmech.NumRoundType.HalfAwayFromZero()
//
//		***************************************************
//
...
// one (String Mechanics 'mathmech') to convert strings
...
//	'Signed' integer or floating point numbers using the
//	numeric value contained int the current instance of
//	NumberStrKernel.
//
//	A signed number is an integer or floating point
//	numeric value which does NOT contain currency
//	symbols. Therefore, the number string returned by
//	this method will NOT contain currency symbols.
//
//	If currency symbols are not required, consider
//	the Signed Number Formatting specifications
//	provided by method:
//
//		NumberStrKernel.FmtSignedNumStrBasic()
//
// ----------------------------------------------------------------
//
...
//	A signed number is an integer or floating point
//	numeric value which does NOT contain currency
//	symbols. Therefore, the returned number string
//	will NOT contain currency symbols.
//
//	Within in the European Union many, if not
//	most, of the member countries subscribe to
...
//	symbols. Therefore, the number string returned by this
//	method will NOT contain	currency symbols.
//
//	If custom decimal separator, integer separators,
//	or negative number sign characters are required,
//	see methods:
...
//	number string which does NOT contain currency
//	symbols. Therefore, the returned number string
//	returned by this method will NOT contain currency
//	symbols.
//
//	If custom decimal separator, integer separators,
//	or negative number sign characters are required,
...
func (numStrKernel *NumberStrKernel) FmtSignedNumStrDefaultsUSParen(
	...
	numStrFmtSpec,
		err = new(NumStrFormatSpec).NewSignedNumDefaultsUSParen(
		numberFieldSpec,
		ePrefix.XCpy(
			"newSignedNumFmtSpec<-"))
...
//	Returns a formatted number string based on the
//	numeric value contained in the current instance
//	of NumberStrKernel using the 'simple' Signed
//	Number String formatting input parameters.
//
//	This Number String Format is designed to format
//	'Signed' integer or floating point numbers using the
//	numeric value contained int the curren instance of
//	NumberStrKernel.
//
//	A signed number is an integer or floating point
//	numeric value which does NOT contain currency
...
//	provided by method:
//
//		NumberStrKernel.FmtCurrencyBasic()
//
// ----------------------------------------------------------------
//
