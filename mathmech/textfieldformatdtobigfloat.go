...
type TextFieldFormatDtoBigFloat struct {
	...
	// by calling method:
	//
	//	TextFieldFormatDtoBigFloat.SetNumStrFmtDefault()
	//
...
//	previously configured in the current instance of
//	TextFieldFormatDtoBigFloat.
//
// ----------------------------------------------------------------
//
...
//		text will be attached to the beginning of the
//		error message.
func (textBigFloatFieldFmtDto *TextFieldFormatDtoBigFloat) FmtNumStrDefault(
	errorPrefix interface{}) (
	string,
	error) {
...
//		text will be attached to the beginning of the
//		error message.
func (textBigFloatFieldFmtDto *TextFieldFormatDtoBigFloat) FmtNumStrNative(
	errorPrefix interface{}) (
	string,
	error) {
...
//		text will be attached to the beginning of the
//		error message.
func (textBigFloatFieldFmtDto *TextFieldFormatDtoBigFloat) FmtNumStrPure(
	errorPrefix interface{}) (
	string,
	error) {
...
//		text will be attached to the beginning of the
//		error message.
func (textBigFloatFieldFmtDto *TextFieldFormatDtoBigFloat) GetDefaultNumStrFmtSpec(
	errorPrefix interface{}) (
	NumStrFormatSpec,
	error) {
	...
	_,
		...
		testValidityOfTxtFieldFmtDtoBigFloat(
			textBigFloatFieldFmtDto,
			ePrefix.XCpy(
				"TextFieldFormatDtoBigFloat Invalid."))
	...
	deepCopyNumStrFmt,
		err = textBigFloatFieldFmtDto.DefaultNumStrFmt.CopyOut(
		ePrefix.XCpy(
			"deepCopyNumStrFmt<-" +
...
//		(String Mechanics 'mathmech') to convert strings
...
//	TextFieldFormatDtoBigFloat specifications for
...
//	method:
//
//		TextFieldFormatDtoBigFloat.FmtNumStrDefault()
//
// ----------------------------------------------------------------
//
// # BE ADVISED
...
//		text will be attached to the beginning of the
//		error message.
func (textBigFloatFieldFmtDto *TextFieldFormatDtoBigFloat) SetNumStrFmtDefault(
	numStrFmtSpec NumStrFormatSpec,
	errorPrefix interface{}) error {
...
//		text will be attached to the beginning of the
//		error message.
func (textBigFloatFieldFmtDto *TextFieldFormatDtoBigFloat) SetNumStrFmtDefaultSimple(
	decSeparatorChars string,
	intSeparatorChars string,
	leadingMinusSign bool,
	errorPrefix interface{}) error {
	...
	newNumStrFormatSpec,
		...
		NewSignedNumSimple(
			...
			intSeparatorChars,
			leadingMinusSign,
			textBigFloatFieldFmtDto.FieldLength,
			textBigFloatFieldFmtDto.FieldJustify,
			ePrefix.XCpy(
				"newNumStrFormatSpec<-"))
	...
	return textBigFloatFieldFmtDto.
		DefaultNumStrFmt.CopyIn(
		&newNumStrFormatSpec,
		ePrefix.XCpy(
			"textBigFloatFieldFmtDto.DefaultNumStrFmt<-"+
