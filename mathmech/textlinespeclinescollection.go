...
//	necessary to construct a line of text formatted with
//	a date time. That date time text line is then added
//	to the Text Specification Lines Collection maintained
...
//		text will be attached to the beginning of the
//		error message.
func (txtLinesSpecCol *TextLineSpecLinesCollection) AddDateTimeLine(
	leftMarginStr string,
	rightMarginStr string,
	dateTime time.Time,
	dateTimeFormat string,
	...
	textString,
		err = newTextFieldDateTime.GetFormattedText(
		ePrefix.XCpy("textString<-"))
...
//	string array to generate a series of new plain text
//	lines. These new plain text lines are then added to
//	the Text Specification Lines Collection maintained by
//	the current instance of TextLineSpecLinesCollection.
//
// ----------------------------------------------------------------
//
// # Input Parameters
...
//
//		A string containing the text characters to be
//		positioned on the left side of every new text
//		line generated from the string arrays contained
//		in input parameter 'textStrings'.
//
//		If no left margin is required, set this parameter
//		to an empty string.
//
...
//
//		A string containing the text characters to be
//		positioned on the right side of every new text
//		line generated from the string arrays contained
//		in input parameter 'textStrings'.
//
//		If no right margin is required, set this
...
//		returned.
//
//	textStrings					StringArrayDto
//
//		An instance of StringArrayDto which contains an
//		internal array of strings. These strings will be
//		used to generate a series of new plain text
//		lines. These new plain text lines are then added
//		to the Text Specification Lines Collection
//		maintained by the current instance of
//		TextLineSpecLinesCollection.
//
...
//		text will be attached to the beginning of the
//		error message.
func (txtLinesSpecCol *TextLineSpecLinesCollection) AddPlainTextStrArray(
	leftMarginStr string,
	rightMarginStr string,
	textStrings StringArrayDto,
	textFieldLength int,
	...
	lenTextStrs := textStrings.GetStringArrayLength()

	if lenTextStrs == 0 {

		err = fmt.Errorf("%v\n"+
			"Error: Input parameter 'textStrings' is invalid!\n"+
			"The 'textStrings' array contains zero strings.\n",
			ePrefix.String())
