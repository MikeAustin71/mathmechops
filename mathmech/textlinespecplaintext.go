...
//
//		Controls the number of white space characters
//		(' ') which will comprise the left margin for the
//		returned instance of TextLineSpecPlainText.
//
//		If the value of 'leftMarginSpaces' is less than
//		zero, an error will be returned.
//
//		If the value of 'leftMarginSpaces' is greater
...
//
//		Controls the number of white space characters
//		(' ') which will comprise the right margin
//		for the returned instance of
//		TextLineSpecPlainText.
//
//		If the value of 'rightMarginSpaces' is less than
//		minus one (-1), an error will be returned.
//
//	textString					string
//
...
//		fully populated instance of TextLineSpecPlainText
//		will be returned.
//
//	error
//
...
//	TextLineSpecPlainText
//
//		If this method completes successfully, a new and
//		fully populated instance of TextLineSpecPlainText
//		will be returned.
//
//	error
...
//
//	The TextLineSpecPlainText type provides formatting
//	specifications for a simple line of text characters
//	for text display, file output or printing.
//
//	The plain text line consists of a left margin, the
//	text string, the right margin and a line termination
//	character or characters. The line termination
//	character is usually a new line character ('\n').
//
//	Left and right margins consist of zero or more
//	characters customized and provided by the calling
//	function.
//
//	This method is similar to:
//		TextLineSpecPlainText.NewPlainTextAllParms()
//
//	The sole difference between the two methods is that
//	this method receives input parameter 'textRunes' as
...
//		which will be used to construct the left margin
//		of the plain text line generated by the current
//		instance of TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
//		or empty rune array, NO error will be generated
//		and the left margin will be effectively
//		eliminated from the plain text line generated by
//		the current instance of TextLineSpecPlainText.
//
//		If the 'leftMarginRunes' string length exceeds
//		one-million characters, an error will be
//		returned.
//
//	rightMarginRunes			[]rune
//
//		An array of runes containing the text characters
//		which will be used to construct the right margin
//		of the plain text line generated by the current
//		instance of TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
//		or empty string, NO error will be generated and
//		the right margin will be effectively eliminated
//		from the plain text line generated by the current
//		instance of TextLineSpecPlainText.
//
//		If the 'rightMarginRunes' array length exceeds
//		one-million characters, an error will be returned.
//
//	textRunes					[]rune
//
//		An array of runes which will be used to configure
//		the text characters generated by the current
//		instance of TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
//		or empty rune array, an error will be returned.
//
//		If this rune array contains more than one-million
//		characters, an error will be returned.
//
//	textFieldLength				int
//
...
//	newLineChars				[]rune
//
//		An array of runes containing the one or more
//		characters used to terminate each line of text
//		generated by the current instance of
//		TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
//		or empty rune array, it will be reset to the
//		default new line value ("\n").
//
//	turnLineTerminatorOff		bool
//
...
//		TextLineSpecPlainText.NewPlainTextRunes()
//
//	The sole difference between the two methods is that
//	this method receives input parameters as strings
//	instead of rune arrays.
//
// ----------------------------------------------------------------
//
// # Input Parameters
...
//		will be used to construct the left margin of the
//		plain text line generated by the current instance
//		of TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
//		or empty string, NO error will be generated and
//		the left margin will be effectively eliminated
//		from the plain text line generated by the current
//		instance of TextLineSpecPlainText.
//
//		If the 'leftMarginStr' string length exceeds
//		one-million characters, an error will be
//		returned.
//
...
//
//		A string containing the text characters which
//		will be used to construct the right margin of the
//		plain text line generated by the current instance
//		of TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
...
//		instance of TextLineSpecPlainText.
//
//		If the 'rightMarginStr' string length exceeds
//		one-million characters, an error will be returned.
//
//	textString					string
//
...
//	newLineChars				string
//
//		A string containing the one or more characters
//		used to terminate each line of text generated by
//		the current instance of TextLineSpecPlainText.
//
//		If this parameter is submitted as a zero length
//		or empty string, it will be reset to the default
//		new line value ("\n").
//
//	turnLineTerminatorOff		bool
//
...
//		to a new, fully populated instance of
//		TextLineSpecPlainText will be returned.
//
//	error
//
//		If this method completes successfully, the
...
//		produced by the current instance of
//		TextLineSpecPlainText will be written to
//		'sBuilder'.
//
//	errorPrefix					interface{}
//
